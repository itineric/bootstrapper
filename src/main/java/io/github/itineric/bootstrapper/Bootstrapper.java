package io.github.itineric.bootstrapper;
...
public class Bootstrapper
{
  ...
  private static void printHelp()
  {
    ...
    System.out.println("  > java -jar bootstrapper.jar -l lib -r io.github.itineric.App -- -a param1 -b param2");
    System.out.println("    Loads all jars inside 'lib' folder then calls "
                         + "io.github.itineric.App.main(\"-a\", \"param1\", \"-b\", \"param2\")");
  }
